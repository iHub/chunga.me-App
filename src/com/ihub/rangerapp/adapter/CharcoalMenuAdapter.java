...
public class CharcoalMenuAdapter extends RecyclerView.Adapter<CharcoalMenuAdapter.ViewHolder> {
	
    private List<MenuItem> menuItems;
    private int rowLayout;
    private CharcoalActivity mAct;
    
    public CharcoalMenuAdapter(List<MenuItem> applications, int rowLayout, CharcoalActivity act) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        CharcoalActivity hAct;
        
        public ViewHolder(View itemView, CharcoalActivity mAct) {
            super(itemView);
		...
		public void onClick(View v) {			
			...
			switch (getPosition()) {
				case 0:
					intent = new Intent(hAct, CharcoalKilnSightingsActivity.class);
					break;
				case 1:
					intent = new Intent(hAct, CharcoalArrestsActivity.class);
					break;
				default:
					break;
				}
