...
public class SuspiciousActivitiesReportAdapter extends AmazingAdapter {

	List<SuspiciousActivityModel> models = new ArrayList<SuspiciousActivityModel>();
	
	Activity activity;
	
	public SuspiciousActivitiesReportAdapter(Activity activity) {
