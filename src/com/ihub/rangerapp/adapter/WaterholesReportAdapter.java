...
public class WaterholesReportAdapter extends AmazingAdapter {

	List<WaterholeModel> models = new ArrayList<WaterholeModel>();
	
	Activity activity;
	
	public WaterholesReportAdapter(Activity activity) {
